...
[![Go Reference](https://pkg.go.dev/badge/github.com/subhradip-bose/openfga-go-sdk.svg)](https://pkg.go.dev/github.com/subhradip-bose/openfga-go-sdk)
[![Release](https://img.shields.io/github/v/release/openfga/go-sdk?sort=semver&color=green)](https://github.com/subhradip-bose/openfga-go-sdk/releases)
...
```
go get -u github.com/subhradip-bose/openfga-go-sdk
```

In your code, import the module and use it:

```go
import "github.com/subhradip-bose/openfga-go-sdk"
...
The documentation below refers to the `openfgaClient`, to read the documentation for `openfgaApi`, check out the [`v0.2.1` documentation](https://github.com/subhradip-bose/openfga-go-sdk/tree/v0.2.1#readme).
...
This project is licensed under the Apache-2.0 license. See the [LICENSE](https://github.com/subhradip-bose/openfga-go-sdk/blob/main/LICENSE) file for more info.
